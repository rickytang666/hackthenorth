"""Isolated H100 experiment for decode/token-delivery overlap."""
import json
...
app = modal.App("dryft-worktree-adoption-research")
...
image = (
    ...
    .add_local_dir("/tmp/dryft-worktree-baseline/engine", "/research/engine")
...
def main(mode: str = "production"):
    ...
    target = HERE.parents[1] / "experiments" / "17-worktree-adoption" / f"{mode}.json"
