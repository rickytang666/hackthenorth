"""Isolated H100 validation of the prefill backend calibration and graph range."""
import json
...
app = modal.App("dryft-prefill-calibration-research")
...
image = (
    ...
    .add_local_dir("/tmp/dryft-prefill-calibration-baseline/engine", "/research/engine")
...
def main(mode: str = "production"):
    ...
    target = HERE.parents[1] / "experiments" / "20-prefill-calibration" / f"{mode}.json"
