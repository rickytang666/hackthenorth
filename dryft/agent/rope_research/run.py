...
app = modal.App("dryft-tiled-rope-research")
...
image = (
    ...
    .add_local_dir("/tmp/dryft-rope-baseline/engine", "/research/engine")
...
def main(mode: str = "production"):
    ...
    target = HERE.parents[1] / "experiments" / "18-tiled-prefill-rope" / f"{mode}.json"
