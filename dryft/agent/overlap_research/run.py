...
app = modal.App("dryft-stream-overlap-research")
...
image = (
    ...
    .add_local_dir("/tmp/dryft-overlap-baseline/engine", "/research/engine")
...
def main(mode: str = "production"):
    ...
    target = HERE.parents[1] / "experiments" / "16-stream-overlap" / f"{mode}.json"
